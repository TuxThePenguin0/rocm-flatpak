...
Flatpak 24.08.  It currently builds OpenCL. The ROCm Runtime
...
24.08 is based on BuildStream2.  
...
```
flatpak build-bundle --runtime ~/rocm-repo rocm.flatpak org.freedesktop.Platform.GL.ROCm 24.08
```
